...
public class DialProgress extends View {
    ...
    public DialProgress(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
        new Thread(new TempUpdateThread()).start();
    }
...
//        registerBroadcastReceiver();
    ...
    private void initConfig(Context context, AttributeSet attrs) {
        ...
        mValue = typedArray.getFloat(R.styleable.DialProgress_value, Constant.DEFAULT_TEMPERATURE_VALUE/*Constant.DEFAULT_VALUE*/);
...
//                            + ";value = " + mValue);
    ...
    class TempUpdateThread implements Runnable {
        public void run() {
...
//        Temperature_Server_Broadcast receiver = new Temperature_Server_Broadcast();
//        IntentFilter filter = new IntentFilter(TestShowViewActivity.RecvDataStatus);
//        mContext.registerReceiver(receiver, filter);
//    }
//
//    public class Temperature_Server_Broadcast extends BroadcastReceiver {
//        @Override
//        public void onReceive(Context context, Intent intent) {
//            String action = intent.getAction();
//            Log.d(TAG, "Server_Broadcast DialProgress get data");
